      ...
      <div className="flex-grow p-6">
        ...
        <div className="bg-stone-300 p-4 rounded-lg shadow">
          {tab === "menu" ? 
            ...
            : tab === "coupon" ?
                <div className="col-span-3 mb-6">
                    <h1 className="flex justify-center text-2xl text-black font-semibold px-4 mx-auto max-w-2xl">Coupon Management</h1>
                    <section>
                        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                            <form onSubmit={() => {}}>
                                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                                    <div class="sm:col-span-2">
                                        ...
                                        <input type="text" name="coupon" id="coupon" value={newCouponItem} onChange={(e) => setNewCouponItem(e.target.value)} className="bg-gray-50 border border-gray-300 text-white text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter Coupon Code" required/>
                                    </div>
                                </div>
                                <button type="submit" className="inline-flex item-center my-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                    Add Coupon
